...
```{r test-info, cache = TRUE, warning = FALSE, results = "hide", fig.asp = 0.618, fig.cap = "Test information function and associated conditional standard error of measurement."}
plan(multiprocess)
...
```{r expected-scores, warning = FALSE, results = "hide"}
plan(multiprocess)
